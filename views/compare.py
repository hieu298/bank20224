...
selected_mã = st.multiselect('Chọn mã:', filtered_list, default=["VPB","CTG","VPB", "VIB", "VCB","VBB","VAB","TPB","TCB","STB","SBB","SHB","SGB","PGB","OCB","NVB","MSB","MBB","LPB","HDB","KLB","EIB","CTG","BID","BVB","ACB","BAB","ABB","NAB"])
